...
describe('shallow', () => {
  ...
  describe('.instance()', () => {
    // FIXME: it's not a React instance is Preact. Reason: constructor munky patching in preact-compat.
    it.skip('should return the component instance', () => {
      class Foo extends Component {
        render() { return <div />; }
      }
  ...
  describe('.find(selector)', () => {
    ...
    // FIXME: every props is the attribute for Preact.
  ...
  describe('.findWhere(predicate)', () => {
    ...
    // FIXME: Preact render null as a empty string.
    it.skip('should not pass in null or false nodes', () => {
      const wrapper = shallow((
        <div>
          <div className="foo bar" />
          {null}
  ...
  describe('.simulate(eventName, data)', () => {
    it('should simulate events', () => {
      class Foo extends Component {
        ...
        render() {
          return (
            <a onClick={this.incrementCount}>foo</a>
          );
        }
      }
  ...
  describe('.setState(newState[, callback])', () => {
    // FIXME: Wrapper setState successfully but it doesn't affect the component.
    it.skip('should set the state of the root node', () => {
      class Foo extends Component {
        constructor(props) {
          super(props);
          this.state = { id: 'foo' };
  ...
  describe('.text()', () => {
    ...
    // FIXME: mount wrapper is not implemented yet
    it.skip('should handle spaces with same behavior as ReactWrapper.text()', () => {
      const Space = (
        <div>
          <div> test  </div>
          <div>Hello
  ...
  describe('.get(index)', () => {
    ...
    // FIXME: refs doesn't work in Preact components https://github.com/developit/preact/issues/50
    it.skip('does not add a "null" key to elements with a ref and no key', () => {
      class Foo extends Component {
        constructor(props) {
          super(props);
  ...
  describe('.getNodes()', () => {
    it('should return the wrapped elements', () => {
      ...
      expect(wrapper.find('span').getElements()).to.containSubset([one, two]);
    });
  });

  // FIXME: Wrapper setState successfully but it doesn't affect the component.
  describe.skip('out-of-band state updates', () => {
